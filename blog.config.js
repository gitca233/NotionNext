...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ggca', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '入门项目经理', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.4041024.xyz', // 网站地址
